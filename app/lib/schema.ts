...
const SITE_URL = 'https://balatrogame.online';
...
export function buildWebSiteSchema() {
    return {
        ...
        name: 'Balatro Game',
        url: SITE_URL,
        description: 'Play Balatro Game free online — no download, no account needed.',
        potentialAction: {
            '@type': 'SearchAction',
            target: {
                '@type': 'EntryPoint',
...
export function buildWebApplicationSchema() {
    return {
        ...
        description:
            'A free browser-based game. Play Balatro Game online instantly.',
        author: {
            '@type': 'Person',
            name: AUTHOR_NAME,
            url: AUTHOR_URL,

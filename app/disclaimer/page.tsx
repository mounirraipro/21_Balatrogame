...
export const metadata: Metadata = {
    title: 'Disclaimer',
    description: 'Read the Balatro Game disclaimer regarding website content accuracy, external links, and general use of our free online game.',
    keywords: ['Balatro Game disclaimer', 'website disclaimer', 'legal disclaimer'],
};
    ...
    return (
        <>
            ...
            <div className="page-content">
                <p>
                    The information provided by Balatro Game (&ldquo;we,&rdquo; &ldquo;us,&rdquo; or &ldquo;our&rdquo;) on balatrogame.online
                ...
                <p>
                    Balatro Game is a browser-based entertainment product provided free of charge. The game
                ...
                <p>
                    Balatro Game displays third-party advertisements (including Google AdSense ads) to
                    ...
                    an endorsement or recommendation by Balatro Game.
                </p>
                ...
                <p>
                    ...
                    has been obtained from reliable sources, Balatro Game is not responsible for any errors

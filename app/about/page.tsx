...
const aboutSchema = [
    {
        ...
        '@type': 'AboutPage',
        name: 'About Balatro Game',
        url: 'https://balatrogame.online/about',
        description: 'Learn about Balatro Game, our mission, and the team behind the game.',
        publisher: {
            '@type': 'Organization',
            name: 'Balatro Game',
...
export const metadata: Metadata = {
    title: 'About Us – Balatro Game',
    description: 'Learn about Balatro Game, our mission, and the team behind the game.',
    keywords: ['about Balatro Game', 'game team', 'who made Balatro Game'],
};
        ...
        <>
            ...
            <div className="page-header">
                <div className="container">
                    <h1 className="gradient-text">About Balatro Game</h1>
            ...
            <div className="page-content">
                <h2>Our Story</h2>
                <p>
                    Balatro Game was born from a simple idea: what if playing Balatro Game could be even simpler and more accessible?. The result is a game
                    that&apos;s instantly intuitive yet endlessly engaging — an experience unlike any other on the web.
                </p>
                <p>
                    We launched Balatro Game with a clear vision — to create a free, accessible, and
                    ...
                    Balatro Game has something for you.
                </p>
                ...
                <p>
                    Every level in Balatro Game is handcrafted with care. We obsess over the details
                    so you can simply enjoy the game.
                </p>

                <h2>What Makes Us Different</h2>
                <p>
                    Balatro Game offers a unique experience compared to similar games in its category.
                </p>
                ...
                <p>
                    ...
                    <a href="/contact">Contact page</a>. Your input helps us make Balatro Game better for
                    everyone.
                </p>
            </div>
        </>

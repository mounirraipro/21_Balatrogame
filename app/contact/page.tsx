...
const SUPPORT_EMAIL = 'hello@balatrogame.online';

export const metadata: Metadata = {
    title: 'Contact Balatro Game',
    description: 'Get in touch with the Balatro Game team for support, feedback, partnerships, accessibility concerns, or privacy questions.',
    keywords: ['contact Balatro Game', 'Balatro Game support', 'game contact'],
    alternates: {
        canonical: '/contact',
    },
};

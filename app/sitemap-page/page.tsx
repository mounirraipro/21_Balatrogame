...
export const metadata: Metadata = {
    ...
    description: 'Browse the complete sitemap of Balatro Game. Find every page on our website including games, blog posts, and information pages.',
    keywords: ['Balatro Game sitemap', 'all pages', 'site navigation'],
    alternates: {
...
const sections = [
    {
        ...
        links: [
            { href: '/', label: 'Home' },
            { href: '/play', label: 'Play Balatro Game' },
    ...
    },
    {
        ...
        links: [
            ...
            { href: '/blog/what-is-jigsolitaire', label: 'What is Balatro Game?' },
        ...
        <>
            <div className="page-header">
                <div className="container">
                    ...
                    <p>Browse every page on Balatro Game.</p>
                </div>
            </div>
